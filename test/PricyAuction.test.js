const {
  ...
  const PricyNFT = artifacts.require('PricyComNFT');
  const PricyAuction = artifacts.require('PricyAuctionMock');
  ...
  contract('PricyAuction', (accounts) => {
    ...
    beforeEach(async () => {  
      this.token = await PricyNFT.new({ from: admin });
      ...
      this.auction = await PricyAuction.new(
        platformFeeAddress,
        {from: admin}
      );
      ...
      describe('validation', async () => {
        ...
        it('fails if endTime is in the past', async () => {
          ...
          await expectRevert(
            ...
            "PricyAuction.createAuction: End time passed. Nobody can bid."
          );
        });
        ...
        it('fails if endTime greater than startTime', async () => {
          ...
          await expectRevert(
            ...
            'PricyAuction.createAuction: End time must be greater than start'
          );
        });
        ...
        it('fails if token already has auction in play', async () => {
          ...
          await expectRevert(
            ...
            'PricyAuction.createAuction: Cannot relist'
          );
        });
        ...
        it('fails if you dont own the token', async () => {
          ...
          await expectRevert(
            ...
            'PricyAuction.createAuction: Not owner and or contract not approved'
          );
        });
