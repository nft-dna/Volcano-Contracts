...
*/
    ...
    VolcanoERC721Tradable ("VolcanoCom", "PRY", address(0), address(0), address(0), address(0), _platformFee, 0, _feeRecipient, false, VolcanoERC721Tradable.contractERC721Options("", "", 1000, 0, 0, 0, "")) 
    {
    }
